...
- **Calendrier (`index.html`)** : correction du double cycle sablier → planning → sablier → planning au retour depuis l'admin ; `showApp()` n'est plus appelé avant que `fbReady` soit vrai.
